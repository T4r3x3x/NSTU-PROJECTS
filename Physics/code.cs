...
namespace PhysicsCompute
{
    class Program
    {
        ...
        static void converter_gen(converter[] CV, float[] Rr, e_circuit[] e)
        {
        ...
        static void generation(int acc, chamber[] C, float tc, converter[] CV)
        {
        ...
        static float single_heat_exchange(int v1, int v2, e_circuit[] e, converter[] CV, chamber[] C, int acc, ref float t_max, float t)
        {
        ...
        static void single_vertex_processing(int v, int v1, int v2, int v3, e_circuit[] e, converter[] CV, float[] Rr, int acc, chamber[] C, ref float t_max, ref float t_mid, ref float Q, float t_environment, float eds, float t)
        {
            float QQ;
        ...
        static void electron_movement(int v_begin, int v_end, bool r, ref float Q, ref float t_mid, float[] Rr, e_circuit[] e, converter[] CV, float t_environment, float t, float eds, int acc, chamber[] C, ref float t_max)
        {
            v_begin = v_begin * acc;
            v_end = v_end * acc;
            if (r == false)
        ...
        static void triple_intersection(int v1, int v2, int v3, bool r, bool output, ref float Q, ref float t_mid, float[] Rr, e_circuit[] e, converter[] CV, float t_environment, float t, float eds, int acc, chamber[] C, ref float t_max)
        {
        ...
        static void quadruple_intersection(int v1, int v2, int v3, int v4, bool r, bool output, ref float Q, ref float t_mid, float[] Rr, e_circuit[] e, converter[] CV, float t_environment, float t, float eds, int acc, chamber[] C, ref float t_max)
        {
            int[] v = { v1, v2, v3, v4 };
        ...
        static void impedance(e_circuit[] e, float[] Rr, int acc, chamber[] C)
        {
            for (int i = 1; i < 7; i++)
            {
                e[i].R *= 10 * acc;
        ...
        static void electricity(ref float t_mid, ref float Q, e_circuit[] e, float[] Rr, converter[] CV, float t_environment, float t, float eds, int acc, chamber[] C, ref float t_max, ref float I, ref float U1, ref float U2)
        {
